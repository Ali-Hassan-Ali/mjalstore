...
class PermissionsDemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = ['home', 'admins', 'roles', 'languages', 'settings', 'categories', 'sub_categories', 'markets', 'cards', 'currencies', 'currency_prices', 'pages', 'payment_methods', 'contact_us', 'cupons'];
