...
class CategoryController extends Controller
{
    ...
    public function destroy(Category $category): \Illuminate\Foundation\Application|\Illuminate\Http\Response|\Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\Routing\ResponseFactory
    {
        if($category->logo) {
    ...
    {
        $ides   = request()->ids;
        $images = Category::find($ides)->pluck('logo')->toArray();
        Storage::disk('public')->delete($images) ?? '';
        Category::destroy($ides);
