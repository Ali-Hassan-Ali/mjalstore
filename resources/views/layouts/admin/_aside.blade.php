...
<aside class="app-sidebar" style="::-webkit-scrollbar-track {
  ...
  border-radius: 10px;
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ request()->is('*home*') ? 'active' : '' }}" href="{{ route('admin.index') }}"><i class="app-menu__icon fa fa-home"></i> <span class="app-menu__label">@lang('site.home')</span></a></li>
