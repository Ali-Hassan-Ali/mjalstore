            ...
            <div class="col-12 col-md-12">
                ...
                <div class="tile shadow">
                	...
                	<div class="row">
	                    ...
	                    {{--status--}}
	                    <x-input.checkbox :required="true" name="status" label="admin.global.status" :value="old('status', $page->status)" col="col-md"/>

	                    {{--order--}}
	                    <x-input.text :required="true" type="number" name="order" label="admin.global.order" :value="$page->order" col="col-md"/>
