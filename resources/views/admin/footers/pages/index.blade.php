                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-pages'))
                            <a href="{{ route('admin.footers.pages.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-pages'))
                            <form method="post" action="{{ route('admin.footers.pages.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
