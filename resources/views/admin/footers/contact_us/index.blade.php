<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.contact_us') }}</x-slot>

    <div><h2>{{ trans('menu.contact_us') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.contact_us') }}</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-contact_us'))
                            <form method="post" action="{{ route('admin.footers.contact_us.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
