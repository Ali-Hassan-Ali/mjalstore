<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.roles') }}</x-slot>

    <div><h2>{{ trans('menu.roles') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.roles') }}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-roles'))
                            <a href="{{ route('admin.managements.roles.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-roles'))
                            <form method="post" action="{{ route('admin.managements.roles.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
