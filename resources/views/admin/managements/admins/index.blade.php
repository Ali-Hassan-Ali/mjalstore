<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.admins') }}</x-slot>

    <div><h2>{{ trans('menu.admins') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.admins') }}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-admins'))
                            <a href="{{ route('admin.managements.admins.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif
