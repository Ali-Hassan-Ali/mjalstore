<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.cupons') }}</x-slot>

    <div><h2>{{ trans('menu.cupons') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.cupons') }}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-cupons'))
                            <a href="{{ route('admin.products.cupons.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-cupons'))
                            <form method="post" action="{{ route('admin.products.cupons.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
