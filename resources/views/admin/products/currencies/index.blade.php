<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.currencies') }}</x-slot>

    <div><h2>{{ trans('menu.currencies') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.currencies') }}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-currencies'))
                            <a href="{{ route('admin.products.currencies.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-currencies'))
                            <form method="post" action="{{ route('admin.products.currencies.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
