<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.market') }}</x-slot>

    <div><h2>{{ trans('menu.market') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.market') }}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-markets'))
                            <a href="{{ route('admin.products.markets.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-markets'))
                            <form method="post" action="{{ route('admin.products.markets.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
