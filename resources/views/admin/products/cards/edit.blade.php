<x-admin.layout.app>
    ...
    <x-slot name="title">
        {{ trans('site.edit') . ' - ' . trans('menu.cards') }}
    </x-slot>
            ...
            <div class="col-12 col-md-8">
                ...
                <div class="tile shadow">
                    ...
                    <div class="row">
                        ...
                        {{--categories--}}
                        <x-input.option required="true" name="category_id" label="site.sub_categories" :lists="$categories" :value="old('category', $card?->subCategory?->parent_id)" col="col-md"/>

                        {{--sub categories--}}
                        <x-input.option required="true" name="sub_category" :disabled='old("sub_category", $card?->category_id) ? false : true' label="site.sub_categories" :lists="$subCategories" :value="old('sub_category', $card?->category_id)" col="col-md"/>

                        {{--markets--}}
                        <x-input.option name="market_id" label="site.markets" :lists="$markets" :hidden='old("market_id", $card->market_id) ? false : true' :value="old('market_id', $card->market_id)" col="col-md"/>

                        {{--price--}}
                        <x-input.text type="number" required="true" name="price" label="site.price" :value="$card->price" col="col-md-6"/>

                        {{--quantity--}}
                        <x-input.text type="number" required="true" name="quantity" label="site.quantity" :value="$card->quantity" col="col-md-6"/>
