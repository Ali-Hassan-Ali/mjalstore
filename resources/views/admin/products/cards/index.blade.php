<x-admin.layout.app>
    ...
    <x-slot name="title">{{ trans('menu.cards') }}</x-slot>

    <div><h2>{{ trans('menu.cards') }}</h2></div>
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{ trans('menu.cards') }}</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-cards'))
                            <form method="post" action="{{ route('admin.products.cards.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
